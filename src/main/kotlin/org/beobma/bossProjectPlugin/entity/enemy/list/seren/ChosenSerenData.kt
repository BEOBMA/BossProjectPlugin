...
import org.beobma.bossProjectPlugin.entity.enemy.list.seren.pattern.Flash
...
class ChosenSerenData(
    ...
    companion object {
        val PHASE_MAP_DATA = BossBattleMapData(
        ...
        val MAP_DATA: BossBattleMapData = PHASE_MAP_DATA
    }
